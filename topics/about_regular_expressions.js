...
test("exec", function() {
    ...
    ok(results.equalTo([digit, 0, digit]), 'what is the value of results?');
});
...
test("match", function() {
    ...
    ok(matches.equalTo([digit, "g"]), 'what is the value of matches?');
});
...
test("replace", function() {
    ...
    equal(['6']['9'], pie, 'what is the value of pie?');
});

...
test("splice", function() {
    ...
    var workingWeek = daysOfWeek.splice(1, 3);
    ok(workingWeek.equalTo(["Tuesday", "Wednesday", "Thursday"]), 'what is the value of workingWeek?');
    ok(daysOfWeek.equalTo(["Monday", "Friday", "Saturday", "Sunday"]), 'what is the value of daysOfWeek?');
});
